...
@Service
@Slf4j
public class ProducerGenericImpl implements ProducerGeneric {
    ...
    public ListenableFuture<SendResult<Integer, String>> sendEvent(ProducerCommon producerObject, String topic) throws JsonProcessingException {
        Integer key = producerObject.getKey();
        String value = objectMapper.writeValueAsString(producerObject);
